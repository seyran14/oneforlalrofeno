...
/**
 * Имя файла из подписи. Эмодзи, кириллица и прочий юникод сохраняются:
 * название «⚡️» должно и в адресе остаться «⚡️», просто в процентной
 * кодировке. Заменяется только то, что действительно ломает пути и адреса —
 * разделители, управляющие символы и зарезервированная пунктуация. Если от
 * подписи ничего не осталось, берётся имя исходного файла.
 */
